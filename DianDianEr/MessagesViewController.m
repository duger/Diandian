...
-(void) autoMovekeyBoard: (float) h{
	...
	toolbar.frame = CGRectMake(0.0f, (float)(530.0-h), 320.0f, 44.0f);
...
- (IBAction)didClickButton:(UIBarButtonItem *)sender {
    ...
    UIView *chatView = [self bubbleView:[NSString stringWithFormat:@"%@:%@", NSLocalizedString(@"me",nil), self.messageString]
								   from:YES];
	[self.chatArray addObject:[NSDictionary dictionaryWithObjectsAndKeys:self.messageString, @"text", @"self", @"speaker", chatView, @"view", nil]];
